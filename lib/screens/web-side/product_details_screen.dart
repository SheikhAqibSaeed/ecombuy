                          ...
                          onPressed: () {
                            setState(() {
                              if (count > 1) {
                                ...
                                if (count > 3) {
                                  newPrice = (count *
                                      allProducts.first.discountPrice!) as int;
                                } else {
                                  newPrice =
                                      (count * allProducts.first.price!) as int;
                                }
                              }
                            });
                          },
